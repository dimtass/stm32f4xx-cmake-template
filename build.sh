...
# Enable tiny printf
: ${USE_TINY_PRINTF:=OFF}
# Default linker script and startup file
...
if [ "${ARCHITECTURE}" == "stm32" ]; then
    CMAKE_FLAGS="${CMAKE_FLAGS} \
                ...
                -DUSE_LINKER_SCRIPT=${USE_LINKER_SCRIPT} \
                -DUSE_STARTUP_FILE=${USE_STARTUP_FILE} \
                -DUSE_DEVICE=${USE_DEVICE} \
...
echo "Linker script     : ${USE_LINKER_SCRIPT}"
echo "Startup file      : ${USE_STARTUP_FILE}"
